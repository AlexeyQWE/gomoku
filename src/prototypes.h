#define TABLE_Y 16
	...
	void move_bot(char tableGame[TABLE_Y][TABLE_Y], int level, int gorizontScore, int vertikalScore, int leftDiagonalScore, int rightDiagonalScore, int gorizontScoreLeft, int vertikalSchetLeft, int leftDiagonalScoreLeft, int rightDiagonalSchetLeft, int hodBot, int left, int right, int down, int up, int choice, int height, int widht);
